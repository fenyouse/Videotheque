...
<meta name="twitter:image" content="http://imposetaconnerie.herokuapp.com/views/images/gif/<?php echo $gif[0]['nom_image'];?>" />
    ...
    <div class="content_gauche">
        ...
        <div class="info_image">
            <h2><?php echo utf8_encode ($gif[0]['titre']);?></h2>
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
            ...
            <div class="fb-share-button" data-href="http://imposetaconnerie.herokuapp.com/gifs_<?php echo $gif[0]['id'];?>" data-layout="button_count"></div></facebook>
        </ul>   
    </div>
