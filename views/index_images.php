...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
            ...
            <div class="fb-comments" data-href="http://imposetaconnerie.herokuapp.com/images_<?php echo $image['id'];?>" data-width="530" data-numposts="4" data-colorscheme="light"></div> 
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
            ...
            <div class="fb-share-button" data-href="http://imposetaconnerie.herokuapp.com/images_<?php echo $image['id'];?>" data-layout="button_count"></div></facebook>
        </ul>   
    </div>
